...
void cam_calibrate(VideoCapture* cap, Mat* cameraMatrix, Mat* distCoeffs)
{
    ...
    for(;;)
    {
        ...
        if ( found)                // If done with success,
        {
            cout << "pattern found \r";
              // improve the found corners' coordinate accuracy for chessboard
                ...
                {
                    cout << endl << imagePoints.size() << endl;
        ...
        if( s.inputCapture.isOpened() && start/*key == 'g'*/ )
        {
            mode = CAPTURING;
            imagePoints.clear();
            start = false;
